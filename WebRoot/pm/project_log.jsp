...
function jump(use){
	if(use==1){
		...
		window.location.href="/MR_ST/pm/validation.jsp?projectId="+projectId+"&sid="+"<%=sid%>";
	}else if(use==3){
		window.location.href="/MR_ST/pm/assignment.jsp?projectId="+projectId+"&sid="+"<%=sid%>";
	}else if(use==4){
		window.location.href="/MR_ST/pm/download_conf.jsp?projectId="+projectId+"&sid="+"<%=sid%>";
	}else if(use==5){
		window.location.href="/MR_ST/pm/validationF.jsp?projectId="+projectId+"&sid="+"<%=sid%>";
	}else if(use==6){
