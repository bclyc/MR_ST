...
<script>
	...
	function jump(){		
		...
		post("/MR_ST/admin/assignment_action.jsp?projectId="+${param.projectId}+"&sid="+"<%=sid%>",comments);	
	...
	function changeCamNum(){
		...
		if(isNaN(comments)||comments==""){
			...
			window.location.href="/MR_ST/admin/change_camnum.jsp?projectId="+${param.projectId}+"&sid="+"<%=sid%>"+"&camNum="+comments;
